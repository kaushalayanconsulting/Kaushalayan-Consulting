              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={idx} className="flex items-center space-x-3">
                    <div className="w-5 h-5 bg-brand-500/10 rounded-full flex items-center justify-center text-brand-400">
                      <Award size={12} />
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute -bottom-6 -right-6 w-32 h-32 bg-brand-500/10 rounded-full blur-3xl -z-10"></div>
            </motion.div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-4">
                    <div className="mt-1.5 w-5 h-5 rounded-full bg-brand-500/10 flex items-center justify-center text-brand-500 shrink-0">
                      <Target size={12} />
                    </div>
      ...
      <section className="section-padding bg-[#172554]/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-300">We specialize in two critical pillars of modern business success.</p>
          </div>

          <div className="grid md:grid-cols-2 gap-8">
            <motion.div 
              whileHover={{ y: -10 }}
              className="bg-white/5 p-10 rounded-3xl shadow-sm border border-white/5"
            >
      ...
      <section className="section-padding bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              <div className="w-14 h-14 bg-brand-500/10 rounded-2xl flex items-center justify-center text-brand-500 mb-8">
                <Award size={28} />
              </div>
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={idx} className="flex items-start space-x-4">
                    ...
                    <p className="text-slate-200 leading-relaxed text-sm md:text-base">{point}</p>
                  </div>
                ))}
              </div>
            </motion.div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center text-brand-500 shrink-0 border border-white/5">
                    <Briefcase size={20} />
                  </div>
                  <div>
                    <h4 className="font-bold text-white">Corporate Background</h4>
                    <p className="text-sm text-slate-400">Trainers with real-world leadership experience in Fortune 500 companies.</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-10 h-10 bg-white/5 rounded-lg flex items-center justify-center text-brand-500 shrink-0 border border-white/5">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-400">Expertise in adult learning principles and interactive training methodologies.</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              ...
              <p className="text-slate-300">Don't just take our word for it. Here's how we've helped organizations transform their workforce.</p>
            </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((t, idx) => (
              <motion.div
                ...
                className="bg-white/5 p-8 rounded-3xl relative border border-white/5"
              >
                <p className="text-slate-200 italic mb-8 leading-relaxed">"{t.content}"</p>
