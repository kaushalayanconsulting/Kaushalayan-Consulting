              ...
              <div className="bg-[#1e1b4b] p-6 md:p-10 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl border border-white/5">
                ...
                <div className="space-y-6 md:space-y-8">
                  <div className="flex items-start space-x-4">
                    <div className="w-10 h-10 md:w-12 md:h-12 bg-white/5 rounded-xl flex items-center justify-center text-brand-400 shrink-0 border border-white/5">
                      <Mail size={20} className="md:w-6 md:h-6" />
                    </div>
                    <div className="flex-grow overflow-hidden">
                      <p className="text-xs md:text-sm font-bold text-white mb-1">Email Us</p>
                      <div className="flex items-center justify-between group">
                        <p className="text-slate-400 text-xs md:text-sm truncate">consultingkaushalayan@gmail.com</p>
                        <button 
                          onClick={() => copyToClipboard('consultingkaushalayan@gmail.com', 'email')}
                          className="p-1.5 md:p-2 text-brand-400 hover:bg-white/10 rounded-lg transition-colors shrink-0"
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex items-center justify-between group">
                        <p className="text-slate-400 text-xs md:text-sm">+91 9958430718</p>
                        <button 
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-white/5 rounded-xl flex items-center justify-center text-brand-400 shrink-0 border border-white/5">
                      <MapPin size={24} />
                    </div>
                    <div>
                ...
                <div className="mt-12 pt-12 border-t border-white/5">
                  ...
                  <div className="flex space-x-4">
                    {['LinkedIn', 'Twitter', 'Facebook'].map(social => (
                      <a key={social} href="#" className="text-xs font-bold text-brand-400 hover:text-brand-500 uppercase tracking-widest">
                        {social}
                      </a>
                    ))}
                  </div>
            ...
            <div className="lg:col-span-2">
              <div className="bg-[#1e1b4b] p-6 md:p-16 rounded-[2rem] md:rounded-[2.5rem] shadow-2xl border border-white/5">
                {submitted ? (
                  ...
                  >
                    <div className="w-16 h-16 md:w-20 md:h-20 bg-white/10 text-brand-400 rounded-full flex items-center justify-center mx-auto mb-6 md:mb-8 border border-white/10">
                      <Send size={32} className="md:w-10 md:h-10" />
                    </div>
                    <h3 className="text-2xl md:text-3xl font-bold text-white mb-4">Message Sent!</h3>
                    <p className="text-slate-400 mb-8 md:mb-10 text-sm md:text-base px-4">Thank you for reaching out. We will get back to you shortly.</p>
                    <button 
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
                    <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                      <div className="space-y-2">
                        ...
                        <input 
                          ...
                          className="w-full px-5 py-3.5 md:px-6 md:py-4 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-all text-sm md:text-base"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full px-5 py-3.5 md:px-6 md:py-4 bg-white/5 border border-white/10 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 transition-all resize-none text-sm md:text-base"
                      ></textarea>
                    </div>
                    ...
                    <button 
                      ...
                      type="submit"
                      className="w-full bg-brand-600 text-white py-4 md:py-5 rounded-xl font-bold text-base md:text-lg hover:bg-brand-500 transition-all shadow-xl shadow-brand-600/10 flex items-center justify-center disabled:opacity-70"
                    >
          ...
          >
            <div className="grid md:grid-cols-2 items-center">
              ...
              <div className="p-8 md:p-16">
                <span className="text-brand-500 font-bold uppercase tracking-widest text-xs md:text-sm mb-4 block">Meet Our Expert</span>
                ...
                <div className="flex flex-wrap gap-3 md:gap-4">
                  <div className="px-3 py-1.5 md:px-4 md:py-2 bg-white/5 rounded-full border border-white/5 text-brand-400 text-xs md:text-sm font-medium">
                    Quality & Training
                  </div>
                  <div className="px-3 py-1.5 md:px-4 md:py-2 bg-white/5 rounded-full border border-white/5 text-brand-400 text-xs md:text-sm font-medium">
                    Six Sigma
